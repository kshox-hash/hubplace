...
.gal-lb-desc{padding:14px 20px 14px;font-size:13.5px;color:var(--soft);line-height:1.6;flex-shrink:0;overflow-y:auto;max-height:110px;word-break:break-word;overflow-wrap:break-word;border-bottom:1px solid var(--border-inner)}
.sdp-hero{
