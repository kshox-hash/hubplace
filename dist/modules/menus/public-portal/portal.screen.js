...
exports.renderPortalHtml = renderPortalHtml;
const html_1 = require("../../../utils/html");
const portal_styles_1 = require("./portal.styles");
const portal_scripts_1 = require("./portal.scripts");
const portal_tab_chat_1 = require("./portal-tab-chat");
const portal_tab_reservas_1 = require("./portal-tab-reservas");
const portal_tab_servicios_1 = require("./portal-tab-servicios");
const portal_tab_resenas_1 = require("./portal-tab-resenas");
const portal_tab_nosotros_1 = require("./portal-tab-nosotros");
function sanitizeBrandColor(c) {
    if (!c)
        return null;
...
function prRow(icon, label, val, badge) {
...
function renderPortalHtml(data) {
    const { businessName, publicSlug, userId, productCount, phone, address, city, brandColor, description, welcomeMessage, instagramUrl, whatsappNumber, businessHours, enabledModules, products, googleClientId, } = data;
    const safeColor = sanitizeBrandColor(brandColor);
    const s = {
        name: (0, html_1.escapeHtml)(businessName),
        slug: (0, html_1.escapeHtml)(publicSlug),
        phone: phone ? (0, html_1.escapeHtml)(phone) : null,
        city: city ? (0, html_1.escapeHtml)(city) : null,
        address: address ? (0, html_1.escapeHtml)(address) : null,
        desc: description ? (0, html_1.escapeHtml)(description) : null,
        welcome: welcomeMessage ? (0, html_1.escapeHtml)(welcomeMessage) : null,
        ig: instagramUrl ? (0, html_1.escapeHtml)(instagramUrl) : null,
        wa: whatsappNumber ? (0, html_1.escapeHtml)(whatsappNumber) : null,
        hours: businessHours ? (0, html_1.escapeHtml)(businessHours) : null,
    };
...
<style>
${(0, portal_styles_1.portalStyles)()}
...
<main class="content-wrap">
  ...
  ${(0, portal_tab_chat_1.chatTabHtml)({ name: s.name, slug: s.slug, desc: s.desc, welcome: s.welcome, enabledModules, phone: s.phone, ig: s.ig, wa: s.wa, hours: s.hours, locationLine, waHref, initials, productCount })}
  ${(0, portal_tab_reservas_1.reservasTabHtml)()}
  ${(0, portal_tab_nosotros_1.nosotrosTabHtml)(products)}
  ${(0, portal_tab_servicios_1.serviciosTabHtml)({ slug: s.slug, productCount })}
  ${(0, portal_tab_resenas_1.resenasTabHtml)()}
</main>
</div>
...
<script>${(0, portal_scripts_1.portalScripts)(publicSlug, businessName, userId, enabledModules, products, { phone: s.phone, address: s.address, city: s.city, description: s.desc, welcomeMessage: welcomeMessage ?? null, businessHours: s.hours, instagramUrl: s.ig, whatsappNumber: s.wa }, initials, googleClientId ?? null)}</script>
</body>
</html>`;
}
